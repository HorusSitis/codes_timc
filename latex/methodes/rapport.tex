...
o\g{u} la partie l\'es\'ee \'etait caract\'eris\'ee par la segmentation effectu\'ee de visu sur ImageJ comme sur la figure \ref{cbf_seg_19}.

\par
L'image en bas \g{a} gauche du tableau, figure \ref{19_pour_contre}, est en effet favorable \g{a} une telle approche, %
puisque les r\'egions l\'es\'ees sont tr\g{e}s difficiles \g{a} limiter sur les images, en niveaux de gris, qui concernent des jour autres que 00.
...
\item\label{19_suivi_temp} Possibilit\'e d'une utilisation sur els jours autres que 00, notamment sur la deuxi\g{e}me moiti\'e du mois que durent les exp\'erimentations ;
...
\etoile
Voici des arguments qui s'opposent \g{a} l'utilisation de Mclust pour caract\'eriser la r\'egion l\'es\'ee, \g{a} partir de tranches enti\g{e}res de cerveau :
...
%
\item Les composantes d'une classification peuvent correspondre \g{a} des structures physiologiques comme nous l'avons vu dasn le premier graphique de cette sous-section, %
...
Ceci va \g{a} l'encontre de l'argument \ref{phy_gau}, come \'etant en faveur de l'utiliation de Mclust.
%
...
donent une classification tr\g{e}s difficile \g{a} lire, pour ne pas dire de mauvaise qualit\'e.
\end{enumerate}
...
L'objectif atteint au cours de ce stage a \'et\'e d'\'elaborer unmod\g{e}le dynamique pour l'\'evolution, voxel par voxel, %
...
\par
Ce mod\g{e}le, qui n'est pas explicitement li\'e \g{e} des m\'ecanismes qui se d\'eroulent \g{e} l'\'echelle cellulaire, %
doit reproduire les r\'esultats obtenus au cours des jours, et des premi\g{e}res semaines, qui suivent l'isch\'emie.

\par
Le mod\g{e}le que j'ai construit est uniquement ispir\'e des observations qui, comme on peut le voir dans les sous-sections pr\'ec\'edentes, %
concernent exclusivement le rat 19. %
Il est donc tr\g{e}s difficile, voire impossible, d'adapter le mod\g{e}le tel quel aux autres rats, %
compte tenu de la mani\g{e}re dont l'exp\'erience et les examens qui les concernent se sont d\'eroul\'es, %
et de diff\'erences mutuelles inn\'ees.

\par
En revanche, les hypoth\g{e}ses simplificatrices pos\'ees pour ce mod\g{e}le, la mani\g{e}re sont elles sont d\'egag\'ees %
...
du moins je l'esp\g{e}re, transposables \g{a} d'autres sujets.
...
\par
Comme nous allons le voir, les hypoth\g{e}ses relativement fortes de ce mod\g{e}le n'ont malheureusement pas permis, \g{a} l'aide des seules donn\'ees IRM au jour 0, %
...
\item\label{var_comp} Pas de variable cach\'ee : Les modalit\'es ADC, BVf, etc d\'efinissent, seules, et localement l'\'etat du syst\g{e}me.
...
\begin{description}
\item[R\'egime cytotoxique :] Il correspond aux remi\g{e}res heures d'isch\'emie, telles qu'elles sont mod\'elis\'ees par exemple. %
...
les effets progressifs de chancements d'\'etat des pixels se cantonnent aux premi\g{e}res minutes de l'isch\'emie, %
les perturbations ressenties localement en dehors de la zone l\'es\'ee sont alors de nature exog\g{e}ne.

\par
Dans un souci de simplicit\'e, je distingue, dans le mod\g{e}le du tisu sain, %
...
%%% Fin. %%%
\item[Etat sain permanent : ] il est annonc\'e par une valeur de CBF sup\'erieur ou \'egale \g{a} 100. %
...
\item Non-progressivit\'e, identique \g{a} \ref{nprog}.
...
d'o\g{u} un manque de donn\'ees pour comencer les calculs.
...
\subsubsection{Une alternative : le mod\g{e}le 3 demi}
...
\etoile
Bien s\^ur, les simulations fond\'ees sur ce mod\g{e}le n'ont pas d'int\'er\^et paratique comparable \g{a} celles qui commencent au jour 0. %
%Toutefois, 
