...
&
%\subfloat[CBF]{
\includegraphics[width=0.2\linewidth,height=1.3cm]{../../images_rapport/30-J00-CBF-seg-slice11.jpg}
%}
\\
\hline
%\subfloat[CMRO2]{
...
\includegraphics[height=2cm,width=0.25\linewidth]{../../images_rapport/19-J00-CBF_clust1-3_lesion.pdf}
%}
&
%\subfloat[CBF : deux clusters.]{%
\includegraphics[height=2cm,width=0.25\linewidth]{../../images_rapport/19-J03-CBF_clust1-3_lesion.pdf}
%}
&
%\subfloat[CBF : deux clusters.]{%
\includegraphics[height=2cm,width=0.25\linewidth]{../../images_rapport/19-J08-CBF_clust1-3_lesion.pdf}
%}
\\
\hline
%\subfloat[BVf : trois clusters.]{%
\includegraphics[height=2cm,width=0.25\linewidth]{../../images_rapport/19-J00-BVf_clust1-3_lesion.pdf}
%}
&
&
%\subfloat[BVf : trois clusters.]{%
\includegraphics[height=2cm,width=0.25\linewidth]{../../images_rapport/19-J08-BVf_clust1-3_lesion.pdf}
%}
\\
\hline
\end{tabular}
...
\hline
%\subfloat[CBF : donn\'ees manquantes, trois clusters]{%
\includegraphics[height=2cm,width=0.25\linewidth]{../../images_rapport/19-J08-CBF_clust_lesion.pdf}
%}
&
%\subfloat[CBF : deux clusters.]{%
\includegraphics[height=2cm,width=0.25\linewidth]{../../images_rapport/19-J15-CBF_clust_lesion.pdf}
%}
&
%\subfloat[CBF : deux clusters.]{%
\includegraphics[height=2cm,width=0.25\linewidth]{../../images_rapport/19-J22-CBF_clust_lesion.pdf}
%}
\\
\hline
%\subfloat[CBF : deux clusters.]{%
\includegraphics[height=2cm,width=0.25\linewidth]{../../images_rapport/19-J15-SO2map_clust_lesion.pdf}
%}
&
%\subfloat[BVf : deux clusters.]{%
\includegraphics[height=2cm,width=0.25\linewidth]{../../images_rapport/19-J22-SO2map_clust_lesion.pdf}
%}
&
%\subfloat[BVf : trois clusters.]{%
\includegraphics[height=2cm,width=0.25\linewidth]{../../images_rapport/19-J08-CMRO2_clust_lesion.pdf}
%}
\\
\hline
\end{tabular}
