...
\etoile
La d\'ependance du cerveau aux apports de la cisculation sanguine est donc tr\g{e}s importante. %
Deux m\'ecanismes de r\'egulation du d\'ebit sanguin c\'er\'ebral (CBF), puis du taux de dioxyg\g{e}ne m\'etabolis\'e (CMRO2), sont pr\'esnt\'es sans la sous-section suivante.

\subsubsection{Baisse de la pression de perfusion sanguine}

C'est la premi\g{e}re cons\'equence de l'interruption de la cisculation sanguine.

\par
La pression de perfusion sanguine $\Delta P$ est d\'efinie par : $\Delta P = P_a - P_v$, o\g{u} $P_a$ et $P_v$ sont respectivement les ressions sanguines art\'erielle et veineuse. %
Elle est essentiellement fonction de la pression art\'erielle \cite{vib_dsc}.

\par
La pression de perfusion $\Delta_P$ et le d\'ebit sanguin c\'er\'ebral CBF satisfont l'\'equation, analogue \g{a} la loi d'Ohm en \'electrocin\'etique :
\begin{equation}
\Delta P = R\times CBF%
...
\begin{enumerate}
\item La viscosit\'e du sang \g{a} laquelle est proportionnelle ;
...
\par
Les limites sup\'erieure et inf\'erieure de la r\'egulation peuvent \g{e}tre modifi\'ees par l'intervention du syst\g{e}me nerveux : voir la figure ci-dessous.
...
interrompt le fonctionnement des enzymes -$K^+ - Na^+-$ATP-ase et $Ca^{++}H-$ATPase situ\'ees \g{a} la surface des cellules nerveuses. %
...
c'est-\g{a}-dire la r\'egion du tissu c\'er\'ebral l\'es\'ee de fa\c con irr\'eversible.
...
Certains radicaux libres comme l'oxyde d'azote (NO) modifient \'egalement les r\'eaction des cellules nerveuses \g{a} certains signaux :
...
Les migraines \g{a} aura sont un exemple de propagation d'ondes de d\'epolarisation qui, dans un tisu sain, entra\^inent une dilatation des vaisseaux sanguins.
\end{description}
...
\par
Le mod\g{e}le est impl\'ement\'e sur une grille de $7\times 7$ pixels. %
